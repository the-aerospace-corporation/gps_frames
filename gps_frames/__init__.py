...
"""
__version__ = "2.8.0"
__copyright__ = "Copyright (C) 2021 The Aerospace Corporation"
...
logger.warning("Running " + __name__ + " version " + __version__)
logger.warning(__copyright__)
logger.warning(__license__)

display_distro_statement(__distribution_statement__, logger)
